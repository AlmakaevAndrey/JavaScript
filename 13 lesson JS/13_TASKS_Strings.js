...
// Напишите простейшую проверку комментариев на стоп слово `fuck` и
// присвойте результат в `boolean` формате в переменную `isBlockedComment`
